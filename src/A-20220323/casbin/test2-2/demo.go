...
func main() {
	connectionString := "postgresql://webuser:web890@10.1.7.240:5432/eth_dw?sslmode=disable"
	...
	e, err := casbin.NewEnforcer("E:\\20.06.16Project\\GOExample\\src\\A-20220323\\casbin\\rbac_model.conf", adapter)
	if err != nil {
		panic(err)
	}
	// 从DB加载策略
