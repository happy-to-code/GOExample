...
// BlockChain step1：修改BlockChain的结构体
...
// CreateBlockChainWithGenesisBlock step2：修改该方法
...
// AddBlockToBlockChain step4：修改该方法
...
// Iterator 2.获取一个迭代器的方法
func (bc *BlockChain) Iterator() *BlockChainIterator {
	return &BlockChainIterator{bc.Tip, bc.DB}
}

// PrintChains step5：新增方法，遍历数据库，打印输出所有的区块信息
