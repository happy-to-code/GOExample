...
func testcollydom() {
	...
	// 有一句c.Limit(&colly.LimitRule{DomainGlob: "*.douban.*", Parallelism: 5})，
	// 表示限制只抓取域名是douban(域名后缀和二级域名不限制)的地址，当然还支持正则匹配某些符合的 URLS
	// ，具体的可以看官方文档。
	...
	*/
	...
	c.Visit("https://dune.xyz/labels/ethereum/0x00000000219ab540356cbb839cbe05303d7705fa")
	c.Wait()
