...
-- 2018年
CREATE TABLE public.tx_history_stat_2018 PARTITION OF public.tx_history_stat
    FOR VALUES FROM ('2018-01-01 00:00:00') TO ('2019-01-01 00:00:00')
    PARTITION BY RANGE (stat_month);
-- 2018年-月
CREATE TABLE public.tx_history_stat_201801 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-01-01 00:00:00') TO ('2018-02-01 00:00:00');
CREATE TABLE public.tx_history_stat_201802 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-02-01 00:00:00') TO ('2018-03-01 00:00:00');
CREATE TABLE public.tx_history_stat_201803 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-03-01 00:00:00') TO ('2018-04-01 00:00:00');
CREATE TABLE public.tx_history_stat_201804 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-04-01 00:00:00') TO ('2018-05-01 00:00:00');
CREATE TABLE public.tx_history_stat_201805 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-05-01 00:00:00') TO ('2018-06-01 00:00:00');
CREATE TABLE public.tx_history_stat_201806 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-06-01 00:00:00') TO ('2018-07-01 00:00:00');
CREATE TABLE public.tx_history_stat_201807 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-07-01 00:00:00') TO ('2018-08-01 00:00:00');
CREATE TABLE public.tx_history_stat_201808 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-08-01 00:00:00') TO ('2018-09-01 00:00:00');
CREATE TABLE public.tx_history_stat_201809 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-09-01 00:00:00') TO ('2018-10-01 00:00:00');
CREATE TABLE public.tx_history_stat_201810 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-10-01 00:00:00') TO ('2018-11-01 00:00:00');
CREATE TABLE public.tx_history_stat_201811 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-11-01 00:00:00') TO ('2018-12-01 00:00:00');
CREATE TABLE public.tx_history_stat_201812 PARTITION OF public.tx_history_stat_2018
    FOR VALUES FROM ('2018-12-01 00:00:00') TO ('2019-01-01 00:00:00');

-- --------------------------------------------------------------------------------------
-- 2019年
CREATE TABLE public.tx_history_stat_2019 PARTITION OF public.tx_history_stat
    FOR VALUES FROM ('2019-01-01 00:00:00') TO ('2020-01-01 00:00:00')
    PARTITION BY RANGE (stat_month);
-- 2019年-月
CREATE TABLE public.tx_history_stat_201901 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-01-01 00:00:00') TO ('2019-02-01 00:00:00');
CREATE TABLE public.tx_history_stat_201902 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-02-01 00:00:00') TO ('2019-03-01 00:00:00');
CREATE TABLE public.tx_history_stat_201903 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-03-01 00:00:00') TO ('2019-04-01 00:00:00');
CREATE TABLE public.tx_history_stat_201904 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-04-01 00:00:00') TO ('2019-05-01 00:00:00');
CREATE TABLE public.tx_history_stat_201905 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-05-01 00:00:00') TO ('2019-06-01 00:00:00');
CREATE TABLE public.tx_history_stat_201906 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-06-01 00:00:00') TO ('2019-07-01 00:00:00');
CREATE TABLE public.tx_history_stat_201907 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-07-01 00:00:00') TO ('2019-08-01 00:00:00');
CREATE TABLE public.tx_history_stat_201908 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-08-01 00:00:00') TO ('2019-09-01 00:00:00');
CREATE TABLE public.tx_history_stat_201909 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-09-01 00:00:00') TO ('2019-10-01 00:00:00');
CREATE TABLE public.tx_history_stat_201910 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-10-01 00:00:00') TO ('2019-11-01 00:00:00');
CREATE TABLE public.tx_history_stat_201911 PARTITION OF public.tx_history_stat_2019
    FOR VALUES FROM ('2019-11-01 00:00:00') TO ('2019-12-01 00:00:00');
CREATE TABLE public.tx_history_stat_201912 PARTITION OF public.tx_history_stat_2019
